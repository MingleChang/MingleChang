#
#  Be sure to run `pod spec lint MingleChang.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "MingleChang often use code"

  s.homepage     = "https://github.com/MingleChang/MingleChang"
  ...
  s.author             = { "Mingle" => "mingle890805@gmail.com" }
  # Or just: s.author    = "Mingle"
  # s.authors            = { "Mingle" => "mingle890805@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/MingleChang/MingleChang.git", :tag => "#{s.version}" }
